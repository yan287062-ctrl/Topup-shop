...
export default function Navbar() {
  return (
    <div className="w-full sticky top-0 z-50">
      <nav className="w-full bg-[#1a1b2e] border-b border-white/10 px-3 py-3 flex items-center justify-between shadow-lg">
        {/* ဘယ်ဘက် Logo နှင့် နာမည် */}
        <Link href="/" className="flex items-center space-x-1.5">
          <img src="/logo.png" alt="Logo" className="w-8 h-8 rounded-full object-cover border border-white/20" />
        ...
        <div className="flex items-center space-x-1.5">
          ...
          <span className="text-[10px] text-white bg-pink-900/40 border border-pink-500/50 px-2 py-1.5 rounded-full font-bold whitespace-nowrap">
            0 Ks
          </span>
          {/* Profile Icon */}
