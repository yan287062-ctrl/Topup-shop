...
export default function Home() {
  ...
  return (
    ...
    >
      {/* 2. Main Brand Color (#023E8A) ကို Background overlay အဖြစ်သုံးထားတယ် */}
      <div className="absolute inset-0 bg-[#023E8A]/30 backdrop-blur-[2px] z-0"></div>
      
      {/* 3. Highlight Color (#00B4D8) Glow Effect */}
      <div className="absolute top-10 left-1/2 -translate-x-1/2 w-[300px] h-[300px] bg-[#00B4D8]/20 rounded-full blur-[120px] pointer-events-none z-0"></div>

      <div className="relative z-10">
        <Navbar />

        <div className="max-w-4xl mx-auto px-4 mb-3 mt-4">
          {/* 4. Background/Text Color (#CAF0F8) */}
        ...
        <div className="max-w-4xl mx-auto px-4 grid grid-cols-4 gap-2 sm:gap-3">
          {games.map((game) => (
            <Link
              key={game.id}
              href={`/topup/${game.id}`}
              // Hover လုပ်ရင် #00B4D8 ရောင်လင်းလာမယ်
              className="bg-[#023E8A]/60 backdrop-blur-md border border-[#00B4D8]/20 shadow-lg rounded-xl overflow-hidden transition-all duration-300 hover:scale-[1.03] hover:bg-[#023E8A]/90 hover:border-[#00B4D8]/60 flex flex-col group"
            >
              <div className="w-full h-16 sm:h-20 relative bg-[#03045E]/80">
                <img 
                  src={game.img} 
                  alt={game.name} 
              ...
              <div className="p-1.5 sm:p-2 flex flex-col justify-between flex-1 bg-[#023E8A]/40 backdrop-blur-sm border-t border-[#00B4D8]/10">
                <h3 className="text-white font-bold text-[9px] sm:text-[11px] truncate">{game.name}</h3>
                <p className="text-[#00B4D8] font-semibold text-[7px] sm:text-[9px] truncate mt-0.5">{game.sub}</p>
              </div>
            </Link>
          ))}
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-[#023E8A] p-8 rounded-3xl border border-[#00B4D8]/20 shadow-lg relative overflow-hidden transition hover:border-[#00B4D8]/50">
               ...
               <p className="text-[#CAF0F8]/80 text-xs relative z-10 leading-relaxed">Choose Mobile Legends, PUBG, or any other supported game. Select the diamond package you need.</p>
            </div>
            ...
            <div className="bg-[#023E8A] p-8 rounded-3xl border border-[#00B4D8]/20 shadow-lg relative overflow-hidden transition hover:border-[#00B4D8]/50">
               ...
               <p className="text-[#CAF0F8]/80 text-xs relative z-10 leading-relaxed">Carefully input your User ID & Zone ID. Our system will automatically verify your account before processing.</p>
            </div>
            ...
            <div className="bg-[#023E8A] p-8 rounded-3xl border border-[#00B4D8]/20 shadow-lg relative overflow-hidden transition hover:border-[#00B4D8]/50">
               ...
               <p className="text-[#CAF0F8]/80 text-xs relative z-10 leading-relaxed">Once you confirm the payment from your wallet, our bot completes the order in less than 5 seconds.</p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 mt-20 flex flex-col md:flex-row gap-10 items-center">
          <div className="w-full md:w-2/5">
            ...
            <Link href="#games">
              {/* 5. CTA Button (#FBB02D - Gold/Orange) */}
              <button className="mt-6 bg-[#FBB02D] hover:bg-[#e8a329] text-[#03045E] text-sm font-extrabold py-3 px-8 rounded-full shadow-[0_0_15px_rgba(251,176,45,0.4)] transition">
                Top up now
              </button>
            </Link>
          </div>
          
          <div className="w-full md:w-3/5 grid grid-cols-2 gap-px bg-[#00B4D8]/20 border border-[#00B4D8]/20 rounded-3xl overflow-hidden">
             <div className="bg-[#023E8A] p-8">
                <p className="text-[#CAF0F8]/60 text-[10px] font-bold uppercase tracking-wider mb-2">Active Users</p>
                <h4 className="text-4xl font-bold text-white">{totalUsers}</h4>
                <p className="text-[#CAF0F8]/40 text-[10px] mt-2">registered on our platform</p>
             </div>
             <div className="bg-[#023E8A] p-8">
                <p className="text-[#CAF0F8]/60 text-[10px] font-bold uppercase tracking-wider mb-2">Supported Products</p>
                <h4 className="text-4xl font-bold text-white">{totalProducts}</h4>
                <p className="text-[#CAF0F8]/40 text-[10px] mt-2">games & services available</p>
             </div>
             <div className="bg-[#023E8A] p-8">
                <p className="text-[#CAF0F8]/60 text-[10px] font-bold uppercase tracking-wider mb-2">Successful Orders</p>
                <h4 className="text-4xl font-bold text-white">{successOrders}</h4>
                <p className="text-[#CAF0F8]/40 text-[10px] mt-2">processed automatically</p>
             </div>
             <div className="bg-[#023E8A] p-8">
                <p className="text-[#CAF0F8]/60 text-[10px] font-bold uppercase tracking-wider mb-2">Avg. Delivery Time</p>
                <h4 className="text-4xl font-bold text-white">{avgDeliveryTime}</h4>
                <p className="text-[#CAF0F8]/40 text-[10px] mt-2">via auto-bot system</p>
             </div>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto px-4 mt-24">
          ...
          <div className="space-y-4">
             <details className="bg-[#023E8A] rounded-2xl border border-[#00B4D8]/20 group overflow-hidden cursor-pointer">
                ...
                <div className="px-6 pb-6 text-[#CAF0F8]/80 text-xs leading-relaxed">
        ...
        <footer className="max-w-5xl mx-auto px-4 mt-24 pt-12 border-t border-[#00B4D8]/20 pb-28 md:pb-12">
          ...
          <div className="text-center text-[#CAF0F8]/40 text-[10px]">
